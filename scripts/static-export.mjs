// Build script for static export (used by Electron CI)
// Temporarily moves non-exportable API routes, builds, then restores them.
...
try {
  console.log("[1/4] Backing up non-exportable API routes...");
  backupApiRoutes();

  console.log("[2/4] Adding output: export to config...");
  addExportConfig();
